    ...
    <footer className="site-footer">
      <div className="footer-cta">
        <div className="footer-cta-copy">
          <p className="footer-eyebrow">Put the checklist to work</p>
          <h2>Turn local visibility into qualified opportunities.</h2>
          <p>We connect Google Business Profile optimization, strong local pages, useful content, and practical measurement around your most valuable markets.</p>
          <div className="footer-actions">
            <a className="footer-button footer-button-light" href="/contact">Build Your Local SEO Plan</a>
