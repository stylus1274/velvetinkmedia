    ...
    <footer className="site-footer">
      <div className="footer-cta">
        <div className="footer-cta-copy">
          <p className="footer-eyebrow">Make the numbers useful</p>
          <h2>Connect local visibility to real business growth.</h2>
          <p>We build practical local SEO systems that make it easier to see what is working, what needs attention, and where the next opportunity lives.</p>
          <div className="footer-actions">
            <a className="footer-button footer-button-light" href="/contact">Build Your Measurement Plan</a>
