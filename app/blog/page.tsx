...
const articles = [
  ...
  },
  {
    ...
    excerpt: "Make your profile accurate, useful, and easier for local customers to choose with a practical, customer-first review process.",
    image: "/insights/google-business-profile-optimization-featured.png",
  ...
  },
  {
    ...
    excerpt: "Compare timing, control, durability, conversion readiness, and measurement to choose the right search investment for your next move.",
