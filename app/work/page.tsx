  ...
  return (
    <header className="site-header" id="top">
      ...
      <nav className="desktop-nav" aria-label="Primary navigation">
        <a href="/services">Services</a><a href="/about-us">About</a><a href="/web-design">Web Design</a><a href="/local-seo">Local SEO</a><a href="/geo-aeo">GEO + AEO</a><a href="/paid-media">Paid Media</a><a href="/work" aria-current="page">Work</a><a href="/blog">Insights</a><a href="/contact">Contact</a>
      </nav>
      <details className="mobile-menu">
        <summary aria-label="Open navigation">Menu</summary>
        <nav aria-label="Mobile navigation"><a href="/services">Services</a><a href="/about-us">About</a><a href="/web-design">Web Design</a><a href="/local-seo">Local SEO</a><a href="/geo-aeo">GEO + AEO</a><a href="/paid-media">Paid Media</a><a href="/work" aria-current="page">Work</a><a href="/blog">Insights</a><a href="/contact">Contact</a></nav>
      </details>
    ...
    <footer className="site-footer">
      <div className="footer-cta">
        <div className="footer-cta-copy">
          <p className="footer-eyebrow">Your project could be next</p>
          <h2>Let&apos;s build work worth showing.</h2>
          <p>Tell us what the business needs to improve. We will help you identify the right starting point and connect the work around a measurable goal.</p>
          <div className="footer-actions"><a className="footer-button footer-button-light" href="tel:+18137975515">Call 813-797-5515</a><a className="footer-button footer-button-outline" href="/contact">Start a Conversation</a></div>
        </div>
